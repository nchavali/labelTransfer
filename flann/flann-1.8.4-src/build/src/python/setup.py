...
def find_path():
    lib_paths = [ os.path.abspath('/home/gneelima/work/code/objectProposals/labelTransfer/flann/flann-1.8.4-src/build/lib'), abspath(join(dirname(dirname(sys.argv[0])), '../../../lib')) ]
